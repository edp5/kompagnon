 ...
 * @returns {Promise<*>}
 */
async function registerUserController(req, res, createUserRepository = null, findUserRepository = null, sendMailActivationService = null, generatePasswordService = null, encodedTokenService = null) {
  try {
    ...
    const userId = await createUserRepository({ firstname, lastname, email, hashedPassword, userType });
    await sendMailActivationService({ firstname, lastname, token: encodedTokenService({ userId }) });
